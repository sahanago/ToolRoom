<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ToolInventory_View.aspx.cs" Inherits="ToolRoom.Pages.ToolInventory_View" %>
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                       <b><h1 class="page-title">Tool Details in Inventory
    <small>View detailed information about a specific tool in the Inventory module</small>
</h1></b>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark sbold uppercase">Tool Details in Inventory</span>
                                        </div>
                                        <div class="actions">
                    <div class="btn-group">
                        <button class="btn default" onclick="redirectToHistory()">History</button>
                        <button class="btn blue" onclick="redirectToEdit()" style="margin-left: 5px;">Edit</button>
                    </div>
                </div>
                                    </div>
        ...
        <span class="required">* </span>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="mt-radio-list" data-error-container="#form_2_membership_error">
                                                        ...
                                                        <label class="md-radiobtn">
                                                            <input type="radio" name="membership" value="2"checked />
                                                            Update in Digital Tool Room
                <span></span>
                                                        </label>
                                                    </div>
        ...
        <span class="required">* </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="name" data-required="1" class="form-control" maxLength="50"value="Engineer"/>
                                                </div>
                                            </div>
                                            <hr />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="name" data-required="1" class="form-control"maxLength="50"value="QualityTesting Services"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="number" name="PO" data-required="1" class="form-control" max="9999999999" value="1234567890" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">
...
Expected Testing Date</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="Date" class="form-control" name="returndate"value="2023-06-15" />
                                                </div>
                                            </div>
     ...
     <script>
        ...
        <script>
            ...
            function redirectToEdit() {
                // Replace 'tooledit.aspx' with the actual URL for the edit page
                window.location.href = 'tooledit.aspx';
            }
        </script>
