            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                       <b><h1 class="page-title"># Tool History
    <small>When a tool is viewed in the Inventory module, the following details will be visible in the Tool History screen.
</small>
</h1></b>
                                ...
                                <div class="portlet light portlet-fit portlet-form bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark sbold ">Tool Details in Inventory</span>
                                        </div>
        ...
        <span class="required">* </span>
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="barcode" data-required="1" class="form-control" autocomplete="off" maxlength="20" value="John Doe" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="number" name="barcode" data-required="1" class="form-control" autocomplete="off" maxlength="20" value="9009089809" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="Date" class="form-control" name="BorrowedDate" value="2023-01-15">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="Date" class="form-control" name="ReturnedDate" value="2023-02-05">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="number" class="form-control" name="EmergencyContact" value="99090909090">
                                                </div>
                                            </div>
