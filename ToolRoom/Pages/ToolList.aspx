...
<a href="javascript:;" class="nav-link nav-toggle">
    ...
    <a href="help.aspx"><i class="icon-bulb"></i>Help</a>
                                ...
                                <div class="col-md-12">
                                    <div class="portlet light bordered"> 
                                        ...
                                        <div class="portlet-body">
                                                 ...
                                                 <table  data-toggle="table" data-url="../Themes/assets/global/plugins/bootstrap-table/data/data8.json" data-height="500" data-show-columns="true" data-id-field="id" data-search="true" ">
...
<!-- END FOOTER -->
        ...
        <script>
            ...
            function actionFormatterHistory(value, row, index) {
                return '<button class="btn blue btn-block btn-history" data-index="' + index + '" style="padding: 2px;">H</button>';
            }
