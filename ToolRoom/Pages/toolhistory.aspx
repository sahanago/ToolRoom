           ...
           <div class="page-container">
               ...
               <div class="page-content-wrapper">
                   ...
                   <div class="page-content">
                       <a href="help.aspx" class="pull-right">Help</a>
        
                  <h1 class="page-title">Tool history :
    <small>Provides details about the tool's past, including borrower information are shown below.</small>
</h1>
                                ...
                                <div class="col-md-12">
                                    <div class="portlet light bordered">  
                                        <div class="portlet-body">
                                            <table id="table-pagination" data-toggle="table" data-url="../Themes/assets/global/plugins/bootstrap-table/data/data7.json" data-height="500" data-search="true">

                                                
                                                <thead> 
                                                    <tr>
                                                       <th data-field="ToolId">Tool id</th>
                                                        <th data-field="BorrowerName" >Borrower name </th>
...
<th data-field="ReturnStatus" data-sortable="true" >Status </th>
